/*
  light_kalman.c is part of the RoseWheel project.
...
double kalman_get_bias() { return q_bias; }
 ...
 */
static const double     Q_angle = 0.03;
static const double     Q_gyro  = 0.001;
 ...
 */
void
kalman_state_update(const double q_m,    /* Pitch gyro measurement, in rad/s */
...
void
kalman_cov_update(const double acc_mx, const double acc_mz
		    /* tilt determined from acceleration sensor */
		  )
{

        angle_err = atan2(acc_mx, -acc_mz) - angle;
        /*
